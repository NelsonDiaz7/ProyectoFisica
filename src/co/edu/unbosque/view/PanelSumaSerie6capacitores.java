...
public class PanelSumaSerie6capacitores extends JPanel {
    ...
    public PanelSumaSerie6capacitores()
    {
        setLayout(null);
        setVisible(false);
        initComponents();
    ...
    public void initComponents()
    {
        ...
        TitledBorder tb = new TitledBorder("Suma de 6 capacitores en Serie");
        ...
        add(btnsumar);
        btnsumar.setActionCommand("SUMARSERIE6");

        btnvolver = new JButton("Volver");
        btnvolver.setBounds(320,170,100,20);
        add(btnvolver);
        btnvolver.setActionCommand("VOLVERSUMARSERIE6");
        ...
        add(btn3capacitor);
        btn3capacitor.setActionCommand("2CAPACITORES6");

        btn4capacitor = new JButton("4 capacitores");
        btn4capacitor.setBounds(140, 215, 112, 20);
        add(btn4capacitor);
        btn4capacitor.setActionCommand("4CAPACITORES6");

        btn5capacitor = new JButton("5 capacitores");
        btn5capacitor.setBounds(265, 215, 112, 20);
        add(btn5capacitor);
        btn5capacitor.setActionCommand("5CAPACITORES6");

        btn2capacitor = new JButton("2 capacitores");
        btn2capacitor.setBounds(390, 215, 112, 20);
        add(btn2capacitor);
        btn2capacitor.setActionCommand(" 2CAPACITORES6");
