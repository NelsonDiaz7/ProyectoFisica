...
public class PanelSumaParalelo5 extends JPanel {
    ...
    public void initComponents()
    {
        ...
        TitledBorder tb = new TitledBorder("Suma capacitores en Paralelo 5");
        ...
        add(btnsumar);
        btnsumar.setActionCommand("SUMARPARALELO_5");

        btnvolver = new JButton("Volver");
        btnvolver.setBounds(290,160,100,20);
        add(btnvolver);
        btnvolver.setActionCommand("VOLVERSUMARPARALELO_5");
        ...
        add(btn2);
        btn2.setActionCommand("BTN2_5");

        btn4 = new JButton("4");
        btn4.setBounds(180,200,50,20);
        add(btn4);
        btn4.setActionCommand("BTN4_5");

        btn3 = new JButton("3");
        btn3.setBounds(240,200,50,20);
        add(btn3);
        btn3.setActionCommand("BTN3_5");

        btn6 = new JButton("6");
        btn6.setBounds(300,200,50,20);
        add(btn6);
        btn6.setActionCommand("BTN6_5");
